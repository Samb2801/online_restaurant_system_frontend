...
function Footer() {
  ...
  <footer className="d-flex flex-wrap align-items-center py-2">
    <p className="col-md-4 mb-0 text-light flex-fill">Created By Samarth</p>
    ...
    <Link to="#" id="about" className="nav-link px-2 text-light" data-bs-toggle="offcanvas" data-bs-target="#about-hotel" data-bs-keyboard="true">About</Link>
    ...
    <Link to="/menu" id = "menu" className="nav-link px-2 text-light">Menu</Link>
    <Link to="/" id = "home" className="nav-link px-2 text-light">Home</Link>
    <Link to="#" id = "offer" className="nav-link px-2 text-light" data-bs-toggle="offcanvas" data-bs-keyboard="true" data-bs-target="#offerModal">Offers</Link>
 ...
 <div className="offcanvas-header">
   ...
   <button id="ab-close" type="button" className="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
 </div>
